...
%o`, message, error2, detail);
  ...
  // src/javascripts/controllers/hello_controller.js
  ...
  __publicField(search_controller_default, "targets", ["searchBar", "keyword"]);

  // src/javascripts/app.js
  var app = Application.start();
  app.register("hello", hello_controller_default);
  app.register("search", search_controller_default);
})();
